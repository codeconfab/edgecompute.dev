...
const config: SiteConfig = {
  ...
  site: 'https://edgecompute.dev',
  // The name of your site, used in the title and for SEO.
  title: 'edgecompute.dev',
  // The description of your site, used for SEO and RSS feed.
  description:
    'Dev blog for Lar Van Der Jagt',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Lar Van Der Jagt',
  // Keywords for SEO, used in the meta tags.
  tags: ['Temporal', 'Edge Compute', 'Ruby', 'Buildkite'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/codeconfab/edgecompute.dev',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/supaspoida',
    mastodon: '',
    email: 'lar@codeconfab.com',
    linkedin: 'https://linkedin.com/in/supaspoida',
    bluesky: '',
  ...
  giscus: {
    repo: 'codeconfab/edgecompute.dev',
    repoId: 'R_kgDOPrJMCg',
    category: 'Post Comments',
    categoryId: 'DIC_kwDOPrJMCs4CvGY4',
